...
<script type="text/javascript" src="js/jquery.reveal.js"></script>
 ...
 <div class="panel panel-default">
                        <div class="panel-heading">
							<font color="red"><h4>Contact</h4></font>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center;">ประวัติการซื้อขาย</th>
                                            <th style="text-align: center;">สถานะ</th>
                                        </tr>
                                    </thead>
                                    <tbody>
										<?php
											$sql = "SELECT lead_id,lead_fname,lead_lname,lead_mobile,lead_tel,lead_email,lead_status FROM lead WHERE user_id = '$_SESSION[users_id]'";
											$result = mysql_query($sql);
											$i = 0;
											while(list($lead_id,$lead_fname,$lead_lname,$lead_mobile,$lead_tel,$lead_email,$lead_status) = mysql_fetch_row($result)){
												if($i%2 == 0){
													...
													echo "<td class='center' style='text-align: center;'><a href='index.php?modules=saler&file=list_activity&lead_id=$lead_id'> <span class='glyphicon glyphicon-list-alt'></span></a></td>";
													echo "<td class='center' style='text-align: center;'>$lead_status</td>";
